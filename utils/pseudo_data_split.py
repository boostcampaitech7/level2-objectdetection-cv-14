...
# 파일 경로 설정
annotation = "/data/ephemeral/home/dataset/train_swin_pseudo_labels.json"
train_path = '/data/ephemeral/home/dataset/pseudo_swin_split/train_data.json'
val_path = '/data/ephemeral/home/dataset/pseudo_swin_split/val_data.json'
